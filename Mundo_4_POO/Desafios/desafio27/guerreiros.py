...
class Guerreiro(Personagem):
    def __init__(self, nome, vida):
        super().__init__(nome, vida, ["soco leve", "soco pesado", "chute leve", "chute pesado"])
...
class Mago(Personagem):
    def __init__(self, nome, vida):
        super().__init__(nome, vida, ["invocação", "conjuração de fogo", "conjuração de gelo", "conjuração elétrica"])
