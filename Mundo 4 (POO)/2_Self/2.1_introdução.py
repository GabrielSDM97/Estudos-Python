...
# A forma como atribuimos os estados acima foge às boas normas.
# Na aula "3.2" faremos da forma correta passando os estados como argumentos para os parâmetros do método construtor da classe.
